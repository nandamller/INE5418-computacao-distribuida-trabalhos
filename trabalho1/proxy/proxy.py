...
REST_SERVER_URL = os.getenv("REST_SERVER_URL", "http://server:5000/urls")
PROXY_HOST = os.getenv("PROXY_BIND_HOST", "0.0.0.0")
PROXY_PORT = int(os.getenv("PROXY_BIND_PORT","8080"))
CACHE_CAPACITY = int(os.getenv("CACHE_CAPACITY", "5"))
